...
public class Meetup implements Comparable<Meetup>{
     ...
     * @param meetupHost
     */
    public Meetup(String meetupName, User meetupHost, Activity activity, LocalDate date, LocalTime time, Privacy privacy){
        this.meetupName = meetupName;
        this.host = new ArrayList<User>();
        this.attendees = new ArrayList<User>();
        this.host.add(meetupHost);
        this.attendees.add(meetupHost);
        this.activity = activity;
        this.meetupDate = date;
        this.meetupTime = time;
