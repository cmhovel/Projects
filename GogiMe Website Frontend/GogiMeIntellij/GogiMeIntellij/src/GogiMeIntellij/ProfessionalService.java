...
public class ProfessionalService extends Advertiser {
     ...
     * @param affiliation
     */
    public ProfessionalService(String firstName, String lastName, String password, Gender userGender, String email, String affiliation) {
        super(firstName, lastName, password, userGender, email, affiliation);
